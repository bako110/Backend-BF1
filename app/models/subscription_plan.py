...
class SubscriptionPlan(Document):
    ...
    price_cents: int = Field(..., ge=0, description="Prix promo en centimes (prix affiché)")
    original_price_cents: Optional[int] = Field(None, ge=0, description="Prix original barré (avant promo), None = pas de promo")
